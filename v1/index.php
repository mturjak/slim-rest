...
$app->post('/register', function() use ($app) {
            ...
            verifyRequiredParams(array('name', 'email', 'password'), $app->request->post());
...
$app->post('/login', function() use ($app) {
            // check for required params
            verifyRequiredParams(array('email', 'password'), $app->request->post());
...
$app->post('/tasks', 'authenticate', function() use ($app) {
            // check for required params
            verifyRequiredParams(array('task'), $app->request->post());
...
$app->get('/tasks', 'authenticate', function() {
            ...
            $results = $db->getAllUserTasks($user_id);
